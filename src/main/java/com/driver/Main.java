...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        gmail.receiveMail(new SimpleDateFormat("dd/mm/yyyy").parse("22/11/2022"), "Tushar", "We are running out of time.");
        ...
        System.out.println("There are " + gmail.findMailsBetweenDates(new SimpleDateFormat("dd/mm/yyyy").parse("21/12/2022"), new SimpleDateFormat("dd/mm/yyyy").parse("24/12/2022")) + " mails between given dates!");
